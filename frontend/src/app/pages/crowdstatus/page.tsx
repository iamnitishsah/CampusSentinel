...
const API_URL = "http://127.0.0.1:8000/api/forecast-all/";
...
const fetchAllForecasts = async (
    ...
    try {
        ...
        // Backend returns array of results for all locations
        ...
        // Map backend results to frontend LocationStatus format
        const results: LocationStatus[] = allResults.map((data) => {
            const capacity = BACKEND_CAPACITIES[data.location_name] || 0;
            const layout = campusLayout[data.location_name] || { x: 50, y: 50, width: 100, height: 80 };
            ...
            return {
                ...
                capacity,
                linkId: encodeURIComponent(data.location_name),
        ...
        // Return error state for all locations
        return Object.keys(BACKEND_CAPACITIES).map((locationName) => {
                        ...
                        {locationStatuses.map((location) => {
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => handleLocationClick(location.linkId)}
                                >
