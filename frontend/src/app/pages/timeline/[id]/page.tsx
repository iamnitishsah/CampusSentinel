...
import { Clock, Wifi, CreditCard, Camera, Activity, Calendar, MapPin, Shield, ArrowLeft, AlertCircle, TrendingUp } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 mt-1">
                  Viewing events for {new Date(date ?? "").toLocaleDateString('en-US', { 
                    weekday: 'long', 
                    year: 'numeric', 
                    month: 'long', 
                    day: 'numeric' 
            ...
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-slate-800/50 hover:bg-slate-800 text-slate-300 rounded-lg border border-slate-700 transition-all duration-200 text-sm font-medium"
            >
                                    ...
                                    <div className="flex items-start gap-3 flex-1">
                                      ...
                                      <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                          ...
                                          <span className={`text-xs ${colors.text}`}>{time.time}</span>
                                        </div>
